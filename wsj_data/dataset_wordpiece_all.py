...
class WSJDataSet(object):
    ...
    def __init__(self, batch_size, charset, base_path, sm ,sample_rate=2, data_path = './data/', preprocessed = True, reduced = False):
    ...
    def get_data(self, wordpiece=True):
        ...
        for i in data_idx:
            ...
            if wordpiece:
                label = self.sm.EncodeAsIds(target_string)
            else:
